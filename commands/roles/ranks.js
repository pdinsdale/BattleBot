module.exports = {
    ...
    let faction1RoleD = message.guild.roles.find(role => role.name === `${client.guildConfig.faction1Role}`);
    let faction2RoleD = message.guild.roles.find(role => role.name === `${client.guildConfig.faction2Role}`);
