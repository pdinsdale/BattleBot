module.exports = {
  ...
  async run(client, message, args) {
    ...
    return channel.fetchMessage(messageID)
      ...
      .catch((err) => {
        message.reply('You must mention a **valid message id**! If the message you want is **not from this channel**, you must **mention a channel as well**! You must also make sure I can **view the channel**!');
        console.log(err);
      });
  },
};
